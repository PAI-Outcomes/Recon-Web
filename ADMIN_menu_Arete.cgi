...
$ntitle = "<i>Arete Pharmacy Network ADMIN menu</i>";
...
sub displayAdminPage {
  ...
  if($USER == 1694 && !$PH_ID ) { 
    ...
    $actions{"Claim Research Tool"} = "AreteRx_Basic_Claim_Research_Tool.cgi";
    $actions{"Payment Research Tool"} = "AreteRx_Basic_Payment_Research_Tool.cgi";
  }
