...
sub displayWebPage {
  $ntitle = "Monthly Accounts Receivable Reports for $inNCPDP";
...
# Look for End_of_Year file
  if ( $ENV =~ /Dev/i ) {
     $outdir    = qq#D:\\WWW\\www.recon-rx.com\\WebShare\\End_of_Month_Copay$Agg#;
  } else {
  ...
  $ntitle = "<BR><BR>Yearly Accounts Receivable Reports for $inNCPDP";
  print qq#<h1 class="page_title">$ntitle</h1>\n#;
