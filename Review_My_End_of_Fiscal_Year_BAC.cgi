...
$ntitle = "End of Fiscal Year Billed Adjudicated Comparison Report for $inNCPDP";
...
# Look for End_of_Year file
  ...
  $outdir    = qq#D:\\WWW\\members.recon-rx.com\\WebShare\\End_of_Fiscal_Year_BAC#;
  ...
  foreach $key (sort { $b <=> $a } keys %dofiles) {
     ...
     $webpath = "https://${ENV}.Recon-Rx.com/Webshare/End_of_Fiscal_Year_BAC/$fname";
