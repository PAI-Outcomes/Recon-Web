...
$ntitle = "Monthly PLB Reports for $inNCPDP";
...
# Look for End_of_Month file
  ...
  $outdir    = qq#D:\\WWW\\members.recon-rx.com\\WebShare\\ReconRx_PLB_Monthly#;
  ...
  foreach $key (sort { $b <=> $a } keys %dofiles) {
     ...
     $webpath = "https://${ENV}.Recon-Rx.com/Webshare/ReconRx_PLB_Monthly${testing}$Agg2/$fname";
