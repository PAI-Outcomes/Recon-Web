...
sub get_reconciled_data_for_pharmacy { 
  ...
  #print "sub get_reconciled_data_for_pharmacy: $phs_ids Entry \n";

  $sql = " SELECT rmt.835remitstbID, chk.R_ISA_BIN, chk.R_TPP, rmt.R_CLP01_Rx_Number, rmt.R_CLP04_Amount_Payed,
                  rmt.R_TCode, rmt.R_TPP_PRI, rmt.Payer_ID, rmt.R_REF02_Value,
...
#    print "PAYER TOTAL\n";
  ...
  #print "\nTotals: $clm_total - $plb_total = $check_total\nCalc Total: $calc_total\nDiff: $diff\n\n";
  #print "WARNING: Calculations don't match check amounts\n" if ( $diff > 10 );
  
  $cnt = $count;

  #print "sub get_reconciled_data_for_pharmacy: Exit.\n";
}
